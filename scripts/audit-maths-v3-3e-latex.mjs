...
for (const dir of chapterDirs) {
  ...
  if (meta.officialSource !== "bo-cycle4-mathematiques-2020") errors.push(slug + ": mauvaise source officielle");
  if (meta.programmeVersion !== "mathematiques-cycle4-2020") errors.push(slug + ": mauvaise version de programme");
...
if (chapterDirs.length !== EXPECTED_CHAPTERS) errors.push("3e: " + chapterDirs.length + " chapitres trouvés au lieu de " + EXPECTED_CHAPTERS);
