...
const MAPPING_FILE=path.join(ROOT,"src","data","mathematiques","programmes","terminale-specialite-2019.part-b.mapping.json");
...
const slugs=[...(mapping.programmeChapters??[]),...(mapping.examResources??[])];
...
for(const dir of chapterDirs){
 ...
 if(meta.officialSource!=="bo-2019-mathematiques-terminale-specialite") errors.push(slug+": mauvaise source officielle");
 if(meta.programmeVersion!=="mathematiques-terminale-specialite-2019") errors.push(slug+": mauvaise version de programme");
...
if(chapterDirs.length!==EXPECTED_CHAPTERS) errors.push("C27: "+chapterDirs.length+" chapitres trouvés au lieu de "+EXPECTED_CHAPTERS);
console.log("Audit Mathématiques V3 — C27 Terminale spécialité partie B + bac");
...
console.log("\nOK — les 7 paquets C27 satisfont le contrat pédagogique V3.");
