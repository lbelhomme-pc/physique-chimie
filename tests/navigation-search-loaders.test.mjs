...
test("search corpus includes published mathematics chapters without planned levels", () => {
  ...
  assert.ok(searchChapters(mathematicsChapters, "nombres entiers").some((chapter) => chapter.id.startsWith("mathematiques:college:6eme:")));
  ...
  assert.deepEqual([...new Set(mathematicsChapters.map((chapter) => chapter.niveau))], ["5eme", "6eme", "1ere-generale", "1ere-specialite-mathematiques", "2nde"]);
});
