...
test("only mathematics levels with published content are exposed as level pages", () => {
  ...
  assert.deepEqual(lyceeLevels.map((level) => level.slug), ["2nde", "1ere-ens-scientifique", "1ere-specialite-mathematiques", "terminale-specialite-mathematiques", "terminale-mathematiques-complementaires"]);
  assert.ok(!lyceeLevels.some((level) => ["1ere-generale", "1ere-technologique", "terminale-generale", "terminale-technologique", "terminale-mathematiques-expertes"].includes(level.slug)));
});
