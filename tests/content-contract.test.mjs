...
test("content contract validates every existing chapter without blocking publication", () => {
  ...
  // C19 added 13 Mathematics 5e packages; C21-C22 add 12 Première specialty packages; C23 adds 5 integrated-ES Mathematics packages.
  assert.equal(audit.summary.chapters, 142);
