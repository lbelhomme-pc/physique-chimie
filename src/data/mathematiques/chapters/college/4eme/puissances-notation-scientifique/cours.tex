...
\section{23. Choisir l'écriture adaptée}

Une même valeur peut être écrite sous plusieurs formes, mais toutes ne sont pas aussi efficaces pour répondre à une question.
...
0{,}000052,
\]
la notation scientifique donne :
\[
4{,}8\times10^{-6}
\]
et :
...
L'exposant montre immédiatement que le second nombre est plus grand.

\begin{methode}
Choisir l'écriture qui rend visible l'information utile :
\begin{itemize}
\item comparaison d'échelles : notation scientifique ;
\item mesure courante : écriture décimale ;
\item conversion avec préfixe : puissance de $10$ ;
\item calcul exact simple : forme la plus lisible.
\end{itemize}
\end{methode}

\section{24. Comprendre l'affichage d'une calculatrice}

Une calculatrice peut afficher :
\[
1{,}28\mathrm{E}{-2}.
\]
...
L'élève doit savoir traduire cet affichage et contrôler son ordre de grandeur.

Si le calcul porte sur :
\[
3{,}2\times10^{-8}
\]
multiplié par :
...
4\times10^5,
\]
un résultat de l'ordre de :
\[
10^3
\]
est impossible puisque les puissances donnent un ordre de :
\[
10^{-3}.
\]

\section{25. Comparer des échelles scientifiques}
...
Le rapport vaut :
\[
\dfrac{2{,}4\times10^{-5}}{1{,}2\times10^{-7}}
=
2\times10^2
=
200.
...
L'objet B est donc environ :
\[
\boxed{200}
\]
fois plus grand.

Ce type de comparaison montre pourquoi les puissances de dix sont particulièrement utiles en sciences : elles permettent de raisonner directement sur des ordres de grandeur très éloignés.
