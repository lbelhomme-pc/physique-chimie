...
- comprendre une fraction comme **nombre**, **quotient** et **opérateur multiplicatif** ;
- relier l’écriture fractionnaire à une division exacte ;
- utiliser une fraction pour résoudre une égalité multiplicative à trou ;
- placer, repérer, comparer, encadrer et ordonner des fractions ;
- reconnaître et produire des fractions égales ;
- additionner et soustraire des fractions dans les cas étudiés ;
- multiplier une fraction par un nombre entier ;
- résoudre des problèmes avec des fractions ;
- comprendre une proportion et l’exprimer sous forme de pourcentage ;
- appliquer un pourcentage à une quantité ou à un nombre.

---

## 1. Une fraction représente un nombre
...
Le nombre $a$ est appelé **numérateur**.

Le nombre $b$ est appelé **dénominateur**.
...
Mais en 6e, on va plus loin : une fraction ne désigne pas seulement une « partie d’un tout ». Elle est un **nombre à part entière**.

---

## 2. Le nouveau sens de quotient
...
## 3. Comprendre le quotient par un partage

Considérons un partage où $3$ unités identiques doivent être réparties équitablement entre $4$ personnes.

<figure>
  <img src="/images/mathematiques/6eme/fractions-partage-quotient.svg" alt="Schéma de trois bandes identiques partagées chacune en quatre parts égales pour illustrer une fraction comme quotient." />
  <figcaption>
    Répartir $3$ unités en $4$ parts égales conduit au quotient $\dfrac{3}{4}$.
  </figcaption>
</figure>
...
La fraction est donc bien le **résultat exact d’un partage**.

---

## 4. Définition du quotient
...
## 5. Égalités multiplicatives à trou
...
### Exemple développé 1 — trouver le nombre manquant
...
## 6. Une fraction peut être inférieure, égale ou supérieure à $1$
...
Cette écriture est appelée ici **nombre mixte** : une partie entière à laquelle on ajoute une fraction inférieure à $1$.

---

## 7. Fraction entière, décimale ou non décimale
...
### Un nombre qui n’a pas d’écriture décimale finie
...
## 8. Placer une fraction sur une demi-droite graduée
...
<figure>
  <img src="/images/mathematiques/6eme/fractions-droite-graduee.svg" alt="Demi-droite graduée dont chaque unité est partagée en quatre parts égales afin de placer plusieurs fractions." />
  <figcaption>
    Lorsque chaque unité est partagée en $4$ parts égales, chaque petite graduation correspond à $\dfrac{1}{4}$.
  </figcaption>
</figure>
...
## 11. Comparer des fractions de même dénominateur
...
## 12. Comparer des fractions de même numérateur

Lorsque deux fractions positives ont le même numérateur, la fraction ayant le **plus petit dénominateur** est la plus grande.
...
## 13. Comparer grâce à des fractions égales
...
## 15. Ordonner des fractions et des nombres mixtes

Pour ordonner plusieurs nombres, on peut :

1. repérer leur partie entière ;
2. utiliser une demi-droite graduée ;
3. transformer certaines fractions en fractions égales ;
4. utiliser des valeurs de référence comme $0$, $\dfrac{1}{2}$, $1$ ou $2$.
...
## 17. Additionner après avoir créé un dénominateur commun simple
...
## 19. Multiplier une fraction par un entier
...
## 20. La fraction comme opérateur multiplicatif
...
## 21. Exemple développé 2 — fraction d’une grandeur
...
## 22. Résoudre un problème avec des fractions
...
- une part d’un tout ;
- un quotient exact ;
- une position sur une demi-droite ;
- une fraction d’une quantité ;
- une proportion.

### Méthode

1. Identifier **ce que représente l’unité**.
2. Identifier le rôle du dénominateur.
3. Identifier le rôle du numérateur.
4. Choisir une représentation si nécessaire.
5. Effectuer le calcul.
6. Interpréter le résultat dans le contexte.

---

## 23. Inventer un problème correspondant à une fraction
...
## 24. Comprendre un pourcentage

Un pourcentage exprime une proportion **pour $100$**.
...
## 27. Exemple développé 3 — comparer deux proportions
...
Cette situation montre pourquoi il faut comparer des **proportions** et pas seulement des effectifs.

---

## 28. Automatismes à maîtriser
...
## 29. Méthode — choisir une représentation utile

Les fractions peuvent être représentées de plusieurs façons :

- bande ou rectangle partagé ;
- disque partagé ;
- demi-droite graduée ;
- tableau de proportion ;
- écriture fractionnaire ;
- écriture décimale lorsque c’est possible ;
- pourcentage dans les cas adaptés.
...
### Confondre fraction et quotient approché
...
### Appliquer un pourcentage sans identifier le tout

Pour calculer une proportion ou un pourcentage, il faut savoir ce qui constitue le **tout**.
...
Le cœur du chapitre consiste à comprendre **ce que signifie la fraction dans chaque situation**, puis à choisir la représentation et le calcul adaptés.
