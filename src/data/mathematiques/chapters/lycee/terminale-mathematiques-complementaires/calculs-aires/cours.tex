...
Le calcul d'aires constitue l'entrée privilégiée de ce thème : l’intégrale mesure une accumulation continue et relie géométrie, primitives et approximation numérique. Elle relie une fonction à ses primitives, permet de calculer des aires et fournit une valeur moyenne adaptée aux grandeurs variables. Le calcul exact et l’interprétation géométrique doivent rester associés : une intégrale est un nombre orienté, pas automatiquement une aire positive.
...
\coursefigure{/images/mathematiques/terminale-mathematiques-complementaires/calculs-aires-1.svg}{Aire sous une courbe positive.}{La zone comprise entre la courbe, l’axe horizontal et deux bornes illustre l’interprétation positive d’une intégrale.}
...
\coursefigure{/images/mathematiques/terminale-mathematiques-complementaires/calculs-aires-2.svg}{Aire entre deux courbes.}{Une zone hachurée entre une courbe supérieure et une courbe inférieure montre l’intégration de leur différence.}
...
\section{Approfondissement : encadrer avant de calculer}
L’intégrale possède aussi un rôle d’encadrement. Si $m\leq f(x)\leq M$ sur $[a,b]$ avec $a<b$, alors
\[
m(b-a)\leq\int_a^b f(x)\,dx\leq M(b-a).
\]
Ce résultat permet de contrôler un calcul exact ou une approximation numérique. Une valeur située hors de cet intervalle signale immédiatement une erreur de primitive, de borne ou de signe.

Pour une fonction monotone, les rectangles à gauche et à droite fournissent des encadrements naturels de l’aire. Lorsque la fonction est croissante et positive, la somme à gauche sous-estime l’intégrale tandis que la somme à droite la surestime. Cette lecture graphique explique pourquoi le raffinement d’un maillage améliore l’approximation.

Dans les problèmes appliqués, les unités sont un outil de vérification puissant. Si $f$ est un débit en litres par minute et si la variable est un temps en minutes, l’intégrale possède une unité de volume en litres. Si le résultat final conserve une unité de débit, le modèle ou l’interprétation est incomplet.
