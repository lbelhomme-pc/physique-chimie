...
\coursefigure{/images/mathematiques/terminale-mathematiques-complementaires/inference-bayesienne-1.svg}{Arbre pondéré d'un test de dépistage.}{L'arbre distingue maladie et absence de maladie puis test positif et négatif avec les probabilités conditionnelles.}
...
\coursefigure{/images/mathematiques/terminale-mathematiques-complementaires/inference-bayesienne-2.svg}{Effet de la fréquence de base sur une valeur prédictive.}{Le schéma compare vrais positifs et faux positifs lorsque l'événement recherché est rare.}
...
\begin{itemize}
\item Confondre $P(A\mid B)$ et $P(B\mid A)$.
\item Oublier la fréquence de base avant d'interpréter un résultat positif.
\item Additionner les probabilités le long d'un chemin au lieu de les multiplier.
\item Confondre sensibilité, spécificité et valeurs prédictives.
\end{itemize}

\section{À retenir}
\begin{aretenir}
La formule de Bayes inverse un conditionnement en combinant la vraisemblance d'une information et la probabilité a priori. Un arbre pondéré ou un tableau d'effectifs sécurise les calculs. Une valeur prédictive dépend toujours de la fréquence de base.
\end{aretenir}
