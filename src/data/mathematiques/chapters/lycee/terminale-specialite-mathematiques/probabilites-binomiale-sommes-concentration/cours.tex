...
% Probabilités : loi binomiale, sommes et concentration
...
La loi binomiale modélise le nombre de succès dans une répétition indépendante d’épreuves de Bernoulli. Le chapitre élargit ensuite la perspective aux sommes de variables aléatoires et aux résultats de concentration qui expliquent pourquoi une fréquence empirique se stabilise autour d’une probabilité.
...
\coursefigure{/images/mathematiques/terminale-specialite-mathematiques/probabilites-binomiale-sommes-concentration-1.svg}{Distribution binomiale discrète.}{Des bâtons de hauteurs différentes représentent les probabilités des nombres de succès autour de l’espérance.}
...
\coursefigure{/images/mathematiques/terminale-specialite-mathematiques/probabilites-binomiale-sommes-concentration-2.svg}{Concentration d’une fréquence autour de la probabilité.}{Plusieurs intervalles de plus en plus resserrés autour de p illustrent la diminution des fluctuations lorsque la taille augmente.}
