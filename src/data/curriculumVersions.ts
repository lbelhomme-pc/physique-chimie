...
export const CURRICULUM_VERSIONS: readonly CurriculumVersionDefinition[] = [
  ...
  {
    id: "mathematiques-cycle3-2020",
    discipline: "mathematiques",
    cycle: "college",
    track: "mathematiques",
    niveaux: ["6eme"],
    officialSourceIds: ["bo-cycle3-mathematiques-2020"],
    label: "Mathématiques — cycle 3 — programme 2020",
    publishedOn: "2020-07-30",
    officialUrl: "https://www.education.gouv.fr/bo/20/Hebdo31/MENE2018714A.htm",
    applicationByLevel: { "6eme": window("2020-2021", "2024-2025") },
  },
  {
    id: "mathematiques-cycle3-2025",
    discipline: "mathematiques",
    cycle: "college",
    track: "mathematiques",
    niveaux: ["6eme"],
    officialSourceIds: ["bo-cycle3-mathematiques-2025"],
    label: "Mathématiques — cycle 3 — programme 2025",
  ...
  },
  {
    ...
    cycle: "lycee",
    track: "mathematiques-specialite",
    niveaux: ["terminale-spe", "terminale-specialite-mathematiques"],
    ...
    applicationByLevel: {
      "terminale-spe": window("2020-2021", "2026-2027"),
      "terminale-specialite-mathematiques": window("2020-2021", "2026-2027"),
    },
  },
  {
    ...
    applicationByLevel: {
      "terminale-spe": window("2027-2028"),
      "terminale-specialite-mathematiques": window("2027-2028"),
    },
  },
  {
    ...
    niveaux: ["terminale-complementaires", "terminale-mathematiques-complementaires"],
    ...
    applicationByLevel: {
      "terminale-complementaires": window("2020-2021", "2026-2027"),
      "terminale-mathematiques-complementaires": window("2020-2021", "2026-2027"),
    },
  },
  {
    ...
    applicationByLevel: {
      "terminale-complementaires": window("2027-2028"),
      "terminale-mathematiques-complementaires": window("2027-2028"),
    },
  },
  {
