...
\begin{tikzpicture}[>=Stealth,scale=1]
 \draw[thick,primary] plot[smooth] coordinates {(0,0) (1,0.6) (2,0.8) (3,0.55) (4,0.0)};
 \foreach \x/\y/\n in {0/0/1,1/0.6/2,2/0.8/3,3/0.55/4,4/0/5}{\fill[dark] (\x,\y) circle (2pt) node[above]{\small $M_\n$};}
 \draw[->,very thick,accent] (2,0.8) -- (2.9,0.55) node[right]{$\vec{v}_3$};
 \draw[->,very thick,examplepink] (3,0.55) -- (3.9,0.05) node[right]{$\vec{v}_5$};
\end{tikzpicture}
\end{document}
